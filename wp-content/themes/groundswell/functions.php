...
function my_login_logo() { ?>
  <style type="text/css">
      body.login div#login h1 a {
          	background-image: url(<?php echo get_bloginfo( 'template_directory' ) ?>/assets/images/groundswell-logo-blue.png);
            background-size: 90%;
			width: auto;
			height: 125px;
			border-top: #015ea6 3px solid;
			border-bottom: #015ea6 3px solid;
...
function create_post_type() {
  ...
  register_post_type( 'Homepage Heros', $args1);
  ...
  register_post_type( 'Case Studies', $args2);
  ...
  register_post_type( 'Recent Works', $args3);
